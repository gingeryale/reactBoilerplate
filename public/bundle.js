	...
	var Nav = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					IndexLink,
					{ to: '/', activeClassName: 'active', activeStyle: { border: '1px solid green' } },
					'Get Weather'
				),
				React.createElement(
					Link,
					{ to: '/about', activeClassName: 'active', activeStyle: { border: '1px solid green' } },
					'About'
				),
				React.createElement(
					Link,
					{ to: '/examples', activeClassName: 'active', activeStyle: { border: '1px solid green' } },
					'Examples'
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=872894082263ac7afe081c790285941e&units=imperial';
	// 872894082263ac7afe081c790285941e
